...
public class LoginBusiness {
    ...
    public ServletResponse<Boolean> Login(User userLogin, HttpServletResponse resp, Cookie[] cookies, HttpSession session) {
        ...
        try {
            ...
            */
            loginCookie.setMaxAge(10800);//Espira en 3 hora
